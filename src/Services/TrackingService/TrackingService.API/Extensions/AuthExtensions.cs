...
{
    public static WebApplicationBuilder AddTrackingAuth(this WebApplicationBuilder builder)
    {
    ...
    public static WebApplicationBuilder AddTrackingAuthorization(this WebApplicationBuilder builder)
    {
